/** Shared certificate layout — landing mockup (React) + PDF generator (Node). */
...
export function getCertificateLabels(locale) {
  if (locale === 'ru') {
    return {
      brand: 'Mentorix',
...
export function buildCertificateViewModel(input = {}, locale = 'az') {
