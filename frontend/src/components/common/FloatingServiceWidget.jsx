...
const SERVICES = [
  ...
  {
    tag: '🔍 REPETİTOR AXTARIŞI',
    title: 'Təcrübəli Müəllim Tapın',
    desc: 'Bakıda və regionlarda fənninizə uyğun təcrübəli repetitorları müqayisə edin.',
    linkText: 'Müəllim Axtarışı',
    linkTo: '/search',
    icon: '🔍',
  },
]
