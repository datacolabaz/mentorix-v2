...
/**
 * Pin seçimi — OpenStreetMap (Google JS açarı billing/domain xəbərdarlığı çıxarmır).
 * Tələbəyə yol üçün Google Maps / Waze linkləri ayrıca qalır.
 */
  ...
  return (
    <div className="space-y-2">
      <p className="text-xs text-token-textMuted leading-relaxed">
        ...
        <span className="block mt-1 text-[10px]">{t('settings.pinMapHint')}</span>
      </p>
