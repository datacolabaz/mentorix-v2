/** Amerika/Kanada seed datasetindən gələn əlavə ixtisas slug-ları (frontend) */

export const AMERICA_FIELD_GROUPS = [
  {
    id: 'media_arts',
...
export const AMERICA_FIELD_MATCH_TERMS = {
...
export const AMERICA_FIELD_RELATED_SLUGS = {
