...
export default function AdminDashboard() {
  ...
  return (
    <div className="p-6">
      ...
      <Link
        to="/admin/analytics"
        className="block mb-6 rounded-2xl border border-primary/30 bg-gradient-to-r from-primary/15 via-[#131820] to-[#0d1016] p-5 hover:border-primary/50 transition-colors"
      >
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h2 className="font-display font-bold text-base text-white">Analitika paneli</h2>
            <p className="text-sm text-gray-400 mt-1">
              Ziyarətçilər, trafik mənbələri, funnel, cihaz payı və son qeydiyyatlar
            </p>
          </div>
