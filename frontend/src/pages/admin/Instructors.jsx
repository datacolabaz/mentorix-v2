    ...
    <div className="p-6">
      ...
      <Modal open={addModal} onClose={() => setAddModal(false)} title="Yeni Muellim">
        <div className="space-y-4">
          <div>
            <label className="block text-xs font-semibold text-token-textMuted uppercase tracking-wider mb-2">Ad Soyad</label>
            <input placeholder="Ali Huseynov" className={inputClass}
              value={form.full_name} onChange={e => setForm(p => ({ ...p, full_name: e.target.value }))} />
          </div>
          <div>
            <label className="block text-xs font-semibold text-token-textMuted uppercase tracking-wider mb-2">Email</label>
            <input type="email" placeholder="muellim@gmail.com" className={inputClass}
              value={form.email} onChange={e => setForm(p => ({ ...p, email: e.target.value }))} />
            <p className="text-[10px] text-token-textMuted mt-1">Tesdiq linki ve 6 reqemli kod bu emaile gonderilir.</p>
          </div>
          <div>
            <label className="block text-xs font-semibold text-token-textMuted uppercase tracking-wider mb-2">Telefon</label>
          ...
          <div>
            ...
            <input placeholder="Riyaziyyat" className={inputClass}
              value={form.subject} onChange={e => setForm(p => ({ ...p, subject: e.target.value }))} />
          </div>
          <div>
            <label className="block text-xs font-semibold text-token-textMuted uppercase tracking-wider mb-2">Billing Novu</label>
      ...
      <Modal open={editModal} onClose={() => setEditModal(false)} title="Muellimi Redakte Et">
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-token-textMuted uppercase tracking-wider mb-2">Email (giriş üçün)</label>
            <input
              type="email"
